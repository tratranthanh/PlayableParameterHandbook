...
| Element | Options |
|---------|---------|
| Tutorial Text | Words and text styling |
| Hand Icon | Pointer image and position |
| Text Color | Match your brand |
| Background Overlay | Dim/focus effect |
...
<!-- TODO: Add tutorial-editor.png showing tutorial customization -->
...
<!-- TODO: Add tutorial-hand.png showing hand/pointer options -->
...
* [Loading Screen](loading-screen.md) - What comes before
* [End Cards](end-cards.md) - What comes after
* [Text Styles](../text-headlines/text-styles.md) - Text formatting
